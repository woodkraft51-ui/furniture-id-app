...
const API = {
  addObservation: function (_caseId: any, _obs: any) {
    return null;
  },
  getObservations: function (_caseId: any) {
    return [];
  },
};
//
...
`;
    ...
    const recoveryUsed = !!(rawResult._recovery || Object.values(observationsByType).flat().some((o: any) => o._recovered));
