...
export const HARDWARE_TYPES: HardwareTypeEntry[] = [
  ...
  },
  {
    ...
    notes: "Per Furniture_Hardware_Identification_System.docx PULL HARDWARE > Drop Pull / Bail Pull > Batwing Bail Pull subtype. 7/7 per A-7. replacement_likelihood HIGH override per Colonial Revival reproduction-market dominance (Rule #4 canonical anchor). related_hardware_types FK to parent per D-HW36-8 subtype-flattening. maker_associations: [] per D-HW35-6. HCL migration (D-PH3HCL-S4-2): per HCL `batwing_brass_pull` typical_date_range \"1720–1790\" + indicator_text \"Bat-wing brass bail pulls with rosette backplates are strongly associated with the William and Mary and early Queen Anne periods, typically made from approximately 1720 to 1790.\"; content migrated from `lib/evidence.ts` HISTORICAL_CLUE_LIBRARY during Block 0.5d. Authoritative for this canonical entry; HCL prototype origin captured for cross-reference.",
  ...
  },
  {
    ...
    notes: "Per Furniture_Hardware_Identification_System.docx HINGE HARDWARE > Strap Hinge. 8/8 era-canonical anchor per A-7 (medieval origins; 1650-1900 furniture use). replacement_likelihood LOW per A-6 default (structural reinforcement function; rarely replaced). maker_associations: [] per D-HW35-6. HCL migration (D-PH3HCL-S4-2): per HCL `victorian_strap_hinge` typical_date_range \"1865–1895\" + indicator_text \"Long decorative strap hinges in this style were widely associated with Victorian-era case furniture and chests, commonly used from approximately 1865 to 1895.\"; content migrated from `lib/evidence.ts` HISTORICAL_CLUE_LIBRARY during Block 0.5d. Authoritative for this canonical entry; HCL prototype origin captured for cross-reference.",
    name: "Strap Hinge",
    parent_category_id: "hardware_category_hinge_hardware",
  ...
  },
  {
    ...
    notes: "Per Furniture_Hardware_Identification_System.docx HINGE HARDWARE > Concealed Euro Hinge. 8/8 AG anchor per A-7. replacement_likelihood HIGH per A-6 default (modern retrofit on antique furniture commonly indicates restoration upgrade per Rule #2 + Rule #4 canonical anchors). AG floor 1960 per D-HW36-4 with notes-field marker per D-HW36-N decade-range interpretation discipline — seed canonical phrasing '1960s-present' does NOT pin specific year; 1960 selected as conservative decade-floor anchor per defensible-defaults + D-FA34-3 notes-field-marker precedent. maker_associations: [] per D-HW35-6. HCL migration (D-PH3HCL-S4-2): per HCL `modern_concealed_hinge` typical_date_range \"post-1950\" + indicator_text \"Cup-style concealed hinges are a HARD NEGATIVE for antique claims — this hardware type was not produced before approximately 1950 and is a strong indicator of modern manufacture or replacement.\"; content migrated from `lib/evidence.ts` HISTORICAL_CLUE_LIBRARY during Block 0.5d. Authoritative for this canonical entry; HCL prototype origin captured for cross-reference.",
  ...
  // ═══════════════════════════════════════════════════════════
  {
    ...
    notes: "Per Furniture_Hardware_Identification_System.docx CASTERS AND MOBILITY HARDWARE > Porcelain Caster. 8/8 era-canonical anchor per A-7 (1840-1910 Victorian-era ceramics-manufacturing peak). replacement_likelihood MEDIUM per A-6 default. Era-bounded soft-boundary per Q3 Option E captured as single-period period_associations with explicit date_ceiling; NO AG (period decline, not industrial-introduction-boundary). maker_associations: [] per D-HW35-6. HCL migration (D-PH3HCL-S4-2): per HCL `porcelain_caster` typical_date_range \"1830–1900\" + indicator_text \"Porcelain casters of this type were widely used on American furniture between approximately 1830 and 1900, and were gradually replaced by rubber-wheeled casters through the early twentieth century.\"; content migrated from `lib/evidence.ts` HISTORICAL_CLUE_LIBRARY during Block 0.5d. Authoritative for this canonical entry; HCL prototype origin captured for cross-reference.",
  ...
  {
    id: "hardware_type_eastlake_brass_pull",
    category: "hardware_type",
    positive_authority: 8,
    hard_negative_authority: 8,
    indicator_text: "An Eastlake brass pull is a late Victorian hardware signal identified by flat or lightly shaped brass plates with crisp incised geometric, linear, floral, or stylized ornament. When original to the piece, it is a strong 1870-1890 Eastlake-era clue, but reproduction pulls and later replacement hardware must be ruled out before using it as a tight date anchor.",
    notes: "Per Block 0.5 HCL migration M2 routing (D-PH3HCL-S3-N). HCL eastlake_pull key. Authored in Block 0.5c to preserve HCL's specificity to incised brass pulls (1870-1890) as distinct from the broader hardware_type_eastlake_hardware type. HCL migration (D-PH3HCL-S4-2): per HCL `eastlake_pull` typical_date_range \"1870–1890\" + indicator_text \"Geometric incised brass hardware in the Eastlake style was fashionable during the Aesthetic Movement period, primarily used from approximately 1870 to 1890.\"; content migrated from `lib/evidence.ts` HISTORICAL_CLUE_LIBRARY during Block 0.5d. Authoritative for this canonical entry; HCL prototype origin captured for cross-reference.",
    name: "Eastlake brass pull",
    parent_category_id: "hardware_category_specialty_and_era_diagnostic_hardware",
    description: "An Eastlake brass pull is a drawer or door pull associated with the Eastlake movement of the late Victorian period. It is usually made of brass or brass-plated metal and commonly features incised, stamped, engraved, or lightly cast surface ornament. Unlike broader Eastlake hardware, this entry is specifically for brass pulls used on drawers, doors, cabinet fronts, desks, dressers, sideboards, washstands, and related case furniture. The key diagnostic feature is the Eastlake-style decoration: straight lines, geometric cuts, stylized flowers, sunbursts, fans, notched borders, angular layouts, and shallow incised ornament rather than the heavy rounded scrollwork of earlier Victorian Rococo Revival hardware.",
    unique_traits: [
      "Incised, stamped, engraved, or shallow-cast geometric ornament on a brass or brass-plated pull.",
      "Flat or moderately shaped backplate, bail pull, drop pull, ring pull, or pendant pull with crisp linear decoration.",
      "Ornament often includes straight lines, notched borders, fans, sunbursts, stylized leaves, simple flowers, rosettes, or angular Victorian patterns.",
      "Usually lighter, flatter, and more geometric than earlier Rococo Revival pulls, which tend to be heavier, more rounded, and more scroll-based.",
      "Often appears as part of a coordinated hardware set across drawers, doors, key escutcheons, hinges, and lock plates.",
      "Strongest as a dating signal when the hardware matches the original holes, shadow marks, wear, oxidation, and style of the furniture.",
    ],
    identifying_characteristics: [
      "Look for crisp incised or stamped decoration on the brass pull plate rather than smooth plain brass or heavy cast scrolling.",
      "Check drawer fronts and door panels for matching original hardware shadows, screw-hole alignment, oxidation halos, and wear patterns behind the pull.",
      "Compare all pulls on the piece. Original Eastlake pulls usually form a consistent set in size, pattern, finish, screw spacing, and aging.",
      "Inspect screw heads, screw slots, hardware backs, nuts, posts, and mounting style for period consistency.",
      "Look for Eastlake furniture context: rectilinear case forms, incised decoration, chamfered edges, geometric carving, ebonized accents, burl panels, and late Victorian proportions.",
      "Use the pull as a stronger dating clue when it appears original to an Eastlake-style case, rather than as a single decorative replacement on an unrelated piece.",
      "Check for modern reproduction signs such as bright uniform brass, machine-perfect casting, Phillips screws, modern plated backs, new threaded posts, or lack of oxidation around the mounting area.",
    ],
    period_associations: [
    ...
    style_associations: [
      { style_label: "Eastlake", date_floor: 1870, date_ceiling: 1890,
    ...
    maker_associations: [],
    position_on_piece: [
      { physical_location: "drawer_front", physical_location_notes: "Primary drawer pull location, especially on dressers, washstands, desks, sideboards, commodes, cabinets, and chests." },
      { physical_location: "door_panel", physical_location_notes: "Door pull location on cabinets, sideboards, cupboards, secretaries, bookcases, and case furniture." },
