...
export const HARDWARE_TYPES: HardwareTypeEntry[] = [
  ...
  },
  {
    ...
    notes: "Per Block 0.5 HCL migration M2 routing (D-PH3HCL-S3-N). HCL eastlake_pull key. Authored in Block 0.5c to preserve HCL's specificity to incised brass pulls (1870-1890) as distinct from the broader hardware_type_eastlake_hardware type.",
