...
export const SPATIAL_BEHAVIORS: SpatialBehaviorEntry[] = [
  ...
  },
  {
    ...
    category: "spatial_behavior",
    name: "Audio/Video Equipment Housings",
    family_id: "family_musical_mechanical",
    description:
      "Furniture-integrated electronic equipment housing behavior where the cabinet form is designed specifically to house, support, organize, conceal, or display electronic media playback equipment within domestic interior context. Forms evolve directly from early 20th century radio cabinetry traditions through phonograph console integration, mid-century television and stereo console production, and contemporary modular media console designs. Construction emphasizes equipment compartments, shelving, ventilation openings, wire-routing accommodations, and acoustically transparent panels for speaker integration. Distinct from media storage (which organizes physical media accessories like discs and cartridges) and integrated entertainment systems (which span architectural-scale wall compositions).",
    structural_attributes: [
      "Broad horizontal proportions matched to seated viewing/listening orientation",
      "Equipment compartments dimensioned for radio, television, turntable, stereo, or hi-fi components",
      "Shelving organized around playback equipment placement and access",
      "Ventilation openings (rear panel perforations, side vents, top grills) supporting equipment heat dissipation",
      "Wire-routing accommodations: rear panel openings, internal channels, or back-panel cable cutouts",
      "Speaker cloth or acoustically transparent panels common in front-facing speaker zones",
      "Decorative veneer or finished cabinetry presenting the piece as furniture rather than equipment",
    ],
    dimensional_patterns: {
      notes: "Width typically 48-84 inches for floor consoles; height typically 24-36 inches matched to seated viewing. Depth 16-22 inches accommodating equipment chassis. Weight 100-300 lbs reflecting hardwood case construction plus electronic equipment. Late-mid-century console examples often largest; 1970s-1980s examples more compact reflecting transistor and integrated circuit miniaturization.",
    },
    positive_authority: 8,
    hard_negative_authority: 8,
    migration_status: "partial",
  },
  {
    ...
    category: "spatial_behavior",
    name: "Coin-Operated Entertainment",
    family_id: "family_musical_mechanical",
    description:
      "Commercial entertainment cabinet behavior where the form is designed for public, semi-public, or commercial deployment with integrated payment systems (coin slots, bill acceptors, token mechanisms, or contemporary digital payment integration) and amusement-oriented playback or gameplay systems. Forms span automated music playback (jukeboxes), interactive electronic gaming (arcade cabinets), and mechanical ball-and-flipper gameplay (pinball machines). Construction emphasizes durable cabinet build for commercial use, visually attention-getting decorative fronts (illuminated panels, chrome trim, decorative artwork), integrated speakers and lighting, and theft/tamper-resistant payment system housing. Strongly associated with American diner culture, dance halls, roadside leisure, bars, lounges, and commercial arcades from c. 1930 forward.",
    structural_attributes: [
      "Integrated payment system: coin slots, bill acceptor, token mechanism, or modern digital payment integration",
      "Durable commercial-grade cabinet construction reflecting heavy public use",
      "Visually attention-getting fronts: illuminated panels, chrome trim, decorative artwork, marquees",
      "Integrated speaker systems for music playback or game audio",
      "Theft/tamper-resistant payment-zone housing (locked coin boxes, reinforced money compartments)",
      "Internal mechanism access via removable panels, hinged service doors, or maintenance-oriented construction",
      "Free-floor placement (not built into walls), enabling commercial siting flexibility",
    ],
    dimensional_patterns: {
      notes: "Floor jukeboxes typically 48-60 inches tall × 30-36 inches wide × 24-30 inches deep, weight 250-450 lbs. Wall jukeboxes 18-28 inches tall × 14-20 inches wide × 6-10 inches deep, weight 25-60 lbs. Upright arcade cabinets typically 65-72 inches tall × 24-30 inches wide × 30-40 inches deep, weight 250-400 lbs. Cocktail arcade cabinets 28-34 inches tall (table height) × 30-42 inches wide × 30-42 inches deep, weight 180-300 lbs. Pinball machines typically 70-78 inches tall × 24-30 inches wide × 50-62 inches deep, weight 250-350 lbs.",
    },
    positive_authority: 8,
    hard_negative_authority: 8,
    migration_status: "partial",
  },
  {
    ...
    category: "spatial_behavior",
    name: "Mechanical Craft Tools",
    family_id: "family_musical_mechanical",
    description:
      "Fiber-processing and textile-production furniture behavior where the form is a working mechanical tool integrating frame structure with mechanical operation (treadle systems, rotating wheels, spindle assemblies, warp tensioning). Distinct from purely decorative or storage furniture by active mechanical function in textile production workflow. Forms span looms (weaving, with warp/weft frame organization) and spinning wheels (yarn/thread production, with rotating wheel and flyer/spindle mechanisms). Construction emphasizes structural rigidity for tensioned fibers, mechanical linkage durability, and operator ergonomics. Strongly associated with Colonial-era domestic and pre-industrial production, continuing through Shaker, Pennsylvania German, Appalachian, and rural American traditions, with contemporary craft revival production from c. 1960 forward.",
    structural_attributes: [
      "Frame-based structural construction sized to accommodate operator interaction (seated for spinning wheels, seated-or-standing for looms)",
      "Mechanical linkage systems: treadles, drive belts, pitman rods, eccentric drives",
      "Rotating components mounted on bearings or pivot points (wheels for spinning wheels, beams and cylinders for looms)",
      "Tensioned-fiber accommodation: warp beam systems for looms, flyer-and-bobbin systems for spinning wheels",
      "Hardwood construction throughout (maple, ash, birch, oak commonly used for structural integrity and dimensional stability under fiber tension)",
      "Operator-oriented sizing and proportions: spinning wheels at seated working height, looms accommodating reach across warp width",
      "Working tool aesthetic: visible mechanical components, functional rather than decorative finish",
    ],
    dimensional_patterns: {
      notes: "Floor looms typically 36-60 inches wide × 36-72 inches deep × 36-60 inches tall, weight 50-200 lbs. Table looms 18-36 inches wide × 18-24 inches deep × 12-24 inches tall, weight 10-40 lbs. Saxony wheels (horizontal flyer-driven) typically 24-36 inches wide × 18-24 inches deep × 30-42 inches tall, weight 15-30 lbs. Castle wheels (vertical compact) 14-20 inches wide × 14-20 inches deep × 30-40 inches tall, weight 12-25 lbs. Great wheels (large hand-driven) 36-48 inches wide × 36-48 inches deep × 48-60 inches tall, weight 20-40 lbs.",
    },
    positive_authority: 8,
    hard_negative_authority: 8,
    migration_status: "partial",
  },
  {
    ...
    category: "spatial_behavior",
    name: "Musical Instrument Cabinets",
    family_id: "family_musical_mechanical",
    description:
      "Acoustic musical instrument furniture behavior where the cabinet form integrates keyboard, reed, pipe, string, or mechanical sound-production systems within a furniture-presented structure. Forms span keyboard instruments (upright piano, grand piano, square piano), reed-and-bellows instruments (pump organ, reed organ), pipe-and-wind instruments (pipe organ), and self-playing mechanical variants (pianola, player piano). Construction emphasizes acoustic resonance (soundboards, internal resonant chambers, structural integrity supporting string tension or wind pressure), keyboard accommodation, action mechanism housing, and furniture-grade decorative presentation reflecting the instrument's role as both functional musical instrument and parlor/domestic focal furnishing. form_pump_organ_cabinet (re-homed to this family during Block 15 per D-MM4a) shares this spatial behavior; pump organ is explicitly excluded from form_musical_instrument_furniture's subtypes per D-MM4 to preserve form_pump_organ_cabinet's Session 2-5 authored canonical content.",
    structural_attributes: [
      "Acoustic resonance accommodation: soundboard housing, internal resonant chamber, structural integrity supporting string tension or wind pressure",
      "Keyboard accommodation: keyboard-depth recess or surface, integrated key action, keyboard-related dimensional constraints",
      "Action mechanism housing: hammer-and-string action (pianos), reed-and-bellows action (pump and reed organs), pipe-and-wind action (pipe organs), music-roll-and-pneumatic action (pianolas and player pianos)",
      "Furniture-grade decorative presentation: veneer work, decorative case carving, ornamental moldings, finished cabinetry reflecting parlor/domestic focal-furnishing role",
      "Maintenance access: back panel openings for action service, removable panels for string and key access, foot treadles or pedals for organ and player piano operation",
      "Substantial weight reflecting hardwood case construction plus string-tension framework or pipe-system mass",
    ],
    dimensional_patterns: {
      notes: "Upright piano typically 48-60 inches tall × 56-66 inches wide × 24-30 inches deep, weight 400-800 lbs. Grand piano 36-42 inches tall × 56-72 inches wide × 60-108 inches deep (length varies by grand class — baby, parlor, concert), weight 500-1300 lbs. Square piano (Federal/Empire era) 30-36 inches tall × 60-72 inches wide × 24-30 inches deep, weight 250-450 lbs. Pump organ 50-72 inches tall × 40-60 inches wide × 18-26 inches deep, weight 150-350 lbs (matches form_pump_organ_cabinet dimensional_thresholds). Reed organ 36-72 inches tall × 36-54 inches wide × 18-24 inches deep, weight 120-300 lbs. Pipe organ varies dramatically (large architectural installations); cabinet/parlor variants 60-96 inches tall × 36-72 inches wide × 24-48 inches deep, weight 200-600 lbs. Pianola and player piano variants match upright piano dimensions with additional music-roll housing.",
    },
    positive_authority: 8,
    hard_negative_authority: 8,
    migration_status: "partial",
  },
  {
    ...
    family_id: "family_musical_mechanical",
    description:
      "Storage furnishing behavior specifically organized around physical media formats — records, compact discs, DVDs, Blu-ray discs, video games, cassettes, and related media accessories. Forms emphasize narrow compartments and shelving dimensioned for media case sizes rather than for books or general storage. Construction emphasizes high vertical capacity (often tower-form), shallow depth matched to media-case footprint, and compact floor footprint maximizing storage per square foot. Distinct from media console / equipment housing behavior (which houses playback equipment) by storage-only focus; distinct from bookcase behavior by media-specific dimensions. Strongly associated with late 20th century American suburban entertainment furniture emerging with home audio/video format proliferation.",
    structural_attributes: [
      "Narrow vertical divisions and shallow shelves dimensioned for media case storage rather than books or general goods",
      "Tall vertical proportions maximizing storage density per floor footprint",
      "Shallow depth (typically 4-8 inches) matched to media case dimensions",
      "Compact floor footprint (typically 10-18 inches square or rectangular footprint)",
      "Open-front design typical in tower forms; some variants include doors for dust protection",
      "Modular and stackable configurations common in late 20th century mass-market production",
      "Standardized shelf spacing matched to specific media format dimensions (CD jewel case, DVD case, video cassette, video game cartridge dimensions)",
    ],
    dimensional_patterns: {
      notes: "Media towers typically 36-72 inches tall × 10-16 inches wide × 6-10 inches deep, weight 10-30 lbs. CD towers shallow (4-6 inches deep) matched to jewel-case width. DVD towers slightly deeper (5-8 inches) for taller case format. Game towers variable depth accommodating mixed cartridge/disc formats. Bookcase comparison: bookcases typically 24-36 inches wide and 8-12 inches deep, distinct dimensional profile from media-specific storage.",
    },
    positive_authority: 8,
    hard_negative_authority: 8,
    migration_status: "partial",
  },
  {
    ...
    category: "spatial_behavior",
    name: "Integrated Entertainment Systems",
    family_id: "family_musical_mechanical",
    description:
      "Architectural-scale entertainment furnishing behavior integrating display, storage, and audiovisual organization into a wall-spanning or room-defining composition. Distinct from media console behavior (freestanding cabinet form) by architectural scale and integrated wall-section presence; distinct from media storage behavior by inclusion of display zones and equipment integration. Forms span home theater units (surround-sound and cinematic-viewing integration) and entertainment walls (broader wall-section compositions with mixed cabinetry, shelving, and display zones). Strongly associated with American suburban interiors of the late 20th century from c. 1980 forward, reflecting integration of large-format television display with home audio systems within designated family-room or media-room environments.",
    structural_attributes: [
      "Architectural scale spanning substantial wall sections (typically 8-16 feet of wall length)",
      "Integrated cabinetry combining display zones, storage compartments, equipment bays, and shelving",
      "Large central display zone dimensioned for television placement",
      "Surround-sound speaker accommodation (corner speakers, side speakers, subwoofer bays)",
      "Equipment bays for audio receivers, gaming systems, streaming devices, and related playback equipment",
      "Cable management and wire routing integrated into cabinet construction",
      "Modular or built-in construction depending on installation context",
    ],
    dimensional_patterns: {
      notes: "Home theater units typically 60-96 inches tall × 96-180 inches wide × 18-30 inches deep, weight 200-500 lbs for freestanding configurations (built-in variants may exceed). Entertainment walls span wider — typically 84-96 inches tall × 120-240 inches wide × 14-24 inches deep, weight 300-800 lbs total across modular sections. Distinguishable from media consoles (single freestanding cabinet, 48-84 inches wide) by architectural-scale presence and integrated multi-component composition.",
    },
    positive_authority: 8,
    hard_negative_authority: 8,
    migration_status: "partial",
  },
  {
    ...
    category: "spatial_behavior",
    name: "Equipment Support Systems",
    family_id: "family_musical_mechanical",
    description:
      "Utility furnishing behavior designed to support, organize, cool, and protect technical equipment systems — audio components, computing equipment, networking gear, and acoustic speaker systems. Forms emphasize open-frame or enclosed rack architecture, adjustable mounting rails for component installation flexibility, ventilation systems for heat dissipation, and cable management integration. Distinct from media console behavior (which presents equipment within furniture-style cabinet) by utility-oriented industrial/institutional construction emphasizing function over decorative presentation. Forms span audio racks (stereo and hi-fi component organization), server racks (institutional computing and networking infrastructure), and speaker cabinets (acoustic enclosures optimizing loudspeaker performance).",
    structural_attributes: [
      "Open-frame or enclosed rack architecture supporting component mounting",
      "Adjustable mounting rails (commonly 19-inch standardized rack rails for institutional/professional equipment; non-standardized for audiophile and consumer formats)",
      "Ventilation systems: perforated panels, integrated cooling fans, open-frame airflow, or top/bottom venting",
      "Cable management infrastructure: cable trays, rear-panel cutouts, vertical cable channels",
      "Vibration-isolation construction in audio rack variants (acoustic resonance affects audio component performance)",
      "Acoustic enclosure construction in speaker cabinet variants (internal damping, acoustic chamber tuning, port construction)",
      "Heavy-duty construction reflecting equipment weight loads and continuous-operation environments",
    ],
    dimensional_patterns: {
      notes: "Audio racks typically 24-48 inches tall × 18-22 inches wide × 16-22 inches deep, weight 25-80 lbs. Server racks 30-84 inches tall (rack-unit increments) × 19-24 inches wide × 24-36 inches deep, weight 60-200 lbs unloaded plus substantial equipment weight loaded. Speaker cabinets vary by speaker class: bookshelf 12-18 inches tall × 6-10 inches wide × 8-12 inches deep, weight 10-25 lbs; floor-standing 32-48 inches tall × 8-14 inches wide × 12-18 inches deep, weight 30-80 lbs.",
    },
    positive_authority: 8,
    hard_negative_authority: 8,
    migration_status: "partial",
  },
  {
    ...
    family_id: "family_musical_mechanical",
    description:
      "Direct-user-interaction technology furnishing behavior integrating displays, controls, and interactive hardware for gaming, simulation, control, or digital interface contexts. Forms emphasize user-oriented ergonomics, display and control integration, and computing or simulation hardware housing. Distinct from arcade cabinet behavior (which is commercial coin-operated) by personal-use or institutional siting; distinct from media console behavior by interactive (rather than passive playback) function. Forms span virtual reality stations (immersive interaction with movement space and sensor mounting), gaming towers (high-performance gaming computer housings with thermal management and visual treatment), and digital interface consoles (institutional and transportation control surfaces). Emerged c. 1970 with the first generation of interactive digital systems and expanded substantially through late 20th and early 21st century technology adoption.",
    structural_attributes: [
      "Display integration: integrated monitors, screen mounts, projection systems",
      "Control surfaces and input hardware: keyboards, controllers, touch interfaces, specialized input devices (steering wheels, joysticks, motion controllers)",
      "User-oriented ergonomic sizing: control reach, viewing angle, seated or standing operation accommodation",
      "Computing or simulation hardware housing: ventilated chassis, cable routing, power management",
      "Open movement space accommodation in VR variants (room-scale interaction requirements)",
      "Thermal management: ventilation systems, cooling fans, often visible RGB or aesthetic lighting in consumer gaming variants",
      "Robust construction reflecting active-use mechanical wear and equipment weight",
    ],
    dimensional_patterns: {
      notes: "VR stations vary by setup type: seated 30-42 inches square footprint with sensor mounting; room-scale 8-12 feet open movement area with perimeter sensor mounting. Gaming towers typically 18-24 inches tall × 8-12 inches wide × 18-22 inches deep, weight 20-50 lbs. Digital interface consoles vary widely by institutional context: control desks 28-36 inches tall × 36-96 inches wide × 24-36 inches deep with integrated display arrays; transportation kiosks 60-78 inches tall × 24-36 inches wide × 18-24 inches deep with user-height touchscreen displays.",
    },
    positive_authority: 8,
    hard_negative_authority: 8,
    migration_status: "partial",
  },
  {
    ...
    family_id: "family_musical_mechanical",
    description:
      "Automated dispensing cabinet behavior where the form integrates payment system, product storage, and dispensing mechanism for unattended product distribution. Distinct from kiosk behavior (which typically involves attended interaction) and arcade cabinet behavior (entertainment-focused payment system) by product-dispensing function — the user pays and receives a physical product (food, beverage, tobacco, or other goods). Forms emphasize internal product storage (shelving, refrigerated compartments, vertical coil dispensing systems), payment system (coin acceptor, bill validator, modern electronic payment integration), and product delivery mechanism (drop chute, hopper, robotic arm in modern variants). Strongly associated with 20th century American commercial culture across roadside, workplace, school, transportation hub, and retail siting.",
    structural_attributes: [
      "Integrated payment system: coin acceptor, bill validator, electronic payment terminal, token mechanism",
      "Internal product storage: shelves, coils, refrigerated compartments, vertical or horizontal stacking systems",
      "Dispensing mechanism: gravity drop, coil rotation, robotic arm, conveyor system",
      "Product display window: front-facing transparent panel showing available products",
      "Product delivery hopper or chute at user-accessible height",
      "Tamper-resistant construction: locked product compartments, reinforced cabinet walls, secured payment box",
      "Refrigerated variants include compressor housing, condenser ventilation, and insulated product compartments",
      "Modern variants include electronic display, network connectivity, and contactless payment integration",
    ],
    dimensional_patterns: {
      notes: "Snack vending machines typically 70-78 inches tall × 36-42 inches wide × 30-36 inches deep, weight 500-800 lbs. Beverage vending machines (refrigerated) 70-78 inches tall × 36-42 inches wide × 28-36 inches deep, weight 600-900 lbs reflecting compressor and refrigeration system weight. Cigarette machines (largely historic now due to regulatory changes) typically smaller: 48-66 inches tall × 24-30 inches wide × 16-22 inches deep, weight 150-300 lbs. Compact countertop variants of various types may be smaller. Modern smart vending and contactless variants vary widely in size based on product category.",
    },
    positive_authority: 8,
    hard_negative_authority: 8,
    migration_status: "partial",
