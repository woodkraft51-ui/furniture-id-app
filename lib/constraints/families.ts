...
export const FAMILIES: FamilyEntry[] = [
...

  {
    ...
    description:
      "This family represents furniture designed to house or enable mechanical or acoustic systems where the mechanism is the form's defining purpose. These pieces are used for music, entertainment, and communication.",
    family_characteristics: [
