...
> Part III reference. The common American furniture woods, how to recognize each, and what it
> suggests. First, the rule that governs the whole atlas.

## The rule: wood supports a date, it never proves one

A wood species tells you about region, market, and style, and it reinforces a date, but **wood alone never dates a piece.** Walnut was used in the 1860s and again in 1930s veneer. Oak appears in 1700 and in 1905. Always read wood alongside construction.
...
- Different secondary woods for drawer parts is honest old construction; one uniform wood or plywood leans modern.
- Never let the wood overrule the nails, the dovetails, and the saw marks.

## Illustration needs
| ID | Shows | Format | Status |
|---|---|---|---|
| WOOD-1 | Grain plates: walnut, oak, mahogany, cherry, maple, pine | Owner photos or CC0 links | NEEDED |
| WOOD-2 | Quartersawn oak ray fleck, close | Owner photo | NEEDED |
| WOOD-3 | Primary vs secondary wood in one drawer | Owner photo | NEEDED |
